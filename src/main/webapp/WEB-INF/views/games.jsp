                    ...
                    <form ng-submit="MGL_T1_ctrl.addGame()" name="gameForm" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="text" ng-model="MGL_T1_ctrl.game.name" id="name" class="form-control input-sm" placeholder="Enter the name of the new game [required]" required ng-minlength="3" />
